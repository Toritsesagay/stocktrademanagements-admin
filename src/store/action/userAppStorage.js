...
export const checkIfAdminIsLoggedIn = () => {
  return async (dispatch, getState) => {
    ...
    //https://stocktrademanagements-backend.onrender.com
      ...
      response = await fetch(`https://stocktrademanagements-backend.onrender.com/adminbytoken`, {
        method: "GET",
        headers:{
...
export const signupAdmin = (data) => {
  ...
  return async (dispatch, getState) => {
    try {
      let response = await fetch(`https://stocktrademanagements-backend.onrender.com/adminsignup`, {
        method: "POST",
        headers: {
          "Content-Type": "application/json",
        },
...
export const fetchUsers = ()=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://stocktrademanagements-backend.onrender.com/users`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const deleteUser = (id)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://stocktrademanagements-backend.onrender.com/users/${id}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const updateUser = (data)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://stocktrademanagements-backend.onrender.com/users/${data._id}`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const fetchDeposits = ()=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://stocktrademanagements-backend.onrender.com/deposits`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const deleteDeposit = (id)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://stocktrademanagements-backend.onrender.com/deposits/${id}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const updateDeposit = (data)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://stocktrademanagements-backend.onrender.com/deposits/${data._id}`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const fetchWithdraws = ()=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://stocktrademanagements-backend.onrender.com/withdraws`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const deleteWithdraw = (id)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://stocktrademanagements-backend.onrender.com/withdraws/${id}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const updateWithdraw = (data)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://stocktrademanagements-backend.onrender.com/withdraws/${data._id}`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const fetchTrades = ()=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://stocktrademanagements-backend.onrender.com/trades`, {
        method: "GET",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const deleteTrade = (id)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://stocktrademanagements-backend.onrender.com/trades/${id}`, {
        method: "DELETE",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const updateTrade = (data)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://stocktrademanagements-backend.onrender.com/trades/${data._id}`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
...
export const updateAdmin = (data)=>{
  return async (dispatch, getState) => {
    ...
    try {
      let response = await fetch(`https://stocktrademanagements-backend.onrender.com/admin/${data._id}`, {
        method: "PATCH",
        headers: {
          "Content-Type": "application/json",
          "header": `${adminToken}`
